...
from strategies.st_each_bar_long_tp_sl_1d_candle import StrategyEachBar_Long_tp_sl_1d_candle
...
from strategies.st_each_bar_long_lr1 import StrategyEachBar_Long_LR1
from strategies.st_each_bar_long_lr import StrategyEachBar_Long_LR
from strategies.st_each_bar_short_lr import StrategyEachBar_Short_LR
...
# cerebro.addstrategy(StrategyEachBar_Long_tp_sl, take_profit_usd=1.0, stop_loss_usd=3.0) # mean: 0.2059
# cerebro.addstrategy(StrategyEachBar_Long_tp_sl_pivot_sma, take_profit_usd=1.0, stop_loss_usd=3.0) # mean: 0.3366
# cerebro.addstrategy(StrategyEachBar_Long_tp_sl_1d_candle, take_profit_usd=0.20, stop_loss_usd=99.0) # mean:
# cerebro.addstrategy(StrategyEachBar_Short_tp_sl_pivot_sma, take_profit_usd=0.20, stop_loss_usd=99.0) # mean: -0.20
# cerebro.addstrategy(StrategyEachBar_Long_MA)
# cerebro.addstrategy(StrategyEachBar_Long_Pivot)

# cerebro.addstrategy(StrategyEachBar_Long_LR1, take_profit_usd=100.0, stop_loss_usd=100.0) # Final Portfolio Value ($): 100000.0 -> 100009.80 (trades: 7, PnL: 9.80, average: 1.40)
cerebro.addstrategy(StrategyEachBar_Long_LR, take_profit_usd=100.0, stop_loss_usd=100.0) # Final Portfolio Value ($): 100000.0 -> 100009.80 (trades: 7, PnL: 9.80, average: 1.40)
# cerebro.addstrategy(StrategyEachBar_Short_LR, take_profit_usd=100.0, stop_loss_usd=100.0) # Final Portfolio Value ($): 100000.0 -> 100009.80 (trades: 7, PnL: 9.80, average: 1.40)
...
if not cerebro.runstrats[0][0].trades:
    ...
    if 0:
        ...
        output_filename = f"{path}/{strategies[0]}_{data_5m._name}_bt_trades.csv"
...
if 1:
    ...
    path = f"backtesting/outputs"
    output_filename = f"{path}/{strategies[0]}_{data_5m._name}_positions.csv"
...
if 1:
    ...
    path = f"backtesting/outputs"
    output_filename = f"{path}/{strategies[0]}_{data_5m._name}_orders.csv"
